...
# Load cleaned data
df = pd.read_csv("cleaned_municipal_waste.csv")
...
X_waste = df_encoded[[
    ...
    "Cost of Waste Management (₹/Ton) (₹/Ton) (₹/Ton) (₹/Ton) (₹/Ton) (₹/Ton) (₹/Ton) (₹/Ton) (₹/Ton) (₹/Ton) (₹/Ton) (₹/Ton) (₹/Ton) (₹/Ton)"
...
# Save model
joblib.dump(model_recycle, "recycling_rate_model.pkl")
