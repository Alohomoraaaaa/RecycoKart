...
# --------------------------
waste_model = joblib.load(open("ml/rate/waste_generated_model.pkl", "rb"))
recycling_model = joblib.load(open("ml/rate/recycling_rate_model.pkl", "rb"))
...
# Load Household CSV
# --------------------------
stats = pd.read_csv("ml/rate/household_waste_stats.csv")
